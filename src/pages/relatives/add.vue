...
<template>
  <view class="add-relative">
    <view class="form card">
      ...
      <!-- 手机号邀请 -->
      <view class="form-item">
        <text class="form-item__label">手机号/账号</text>
        <input class="form-item__input" v-model="form.phone" placeholder="邀请对方绑定（选填）" />
      </view>
    </view>

    <!-- 提交 -->
    <view class="submit-area">
      <view class="btn btn-primary" @tap="onSubmit">确认添加</view>
    </view>
...
.add-relative { min-height: 100vh; padding: $spacing-base; }
...
.form-item {
  ...
  &__input {
    width: 100%; font-size: $font-size-base; padding: 8rpx 0;
...
.gender-btn {
  padding: 12rpx 40rpx; border-radius: $radius-lg; font-size: $font-size-sm;
